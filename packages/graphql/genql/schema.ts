...
export interface MutationRequest{
    ...
    removeComment?: [{articleID: Scalars['String'],commentID: Scalars['String']},CommentRequest]
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface MutationPromiseChain{
    ...
    removeComment: ((args: {articleID: Scalars['String'],commentID: Scalars['String']}) => CommentPromiseChain & {get: <R extends CommentRequest>(request: R, defaultValue?: FieldsSelection<Comment, R>) => Promise<FieldsSelection<Comment, R>>})
}
...
export interface MutationObservableChain{
    ...
    removeComment: ((args: {articleID: Scalars['String'],commentID: Scalars['String']}) => CommentObservableChain & {get: <R extends CommentRequest>(request: R, defaultValue?: FieldsSelection<Comment, R>) => Observable<FieldsSelection<Comment, R>>})
}
